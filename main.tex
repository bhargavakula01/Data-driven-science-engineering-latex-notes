...
\begin{itemize}
    ...
    \begin{itemize}
        \item Example: If $x$ is $K$-sparse in $\psi$ then instead of measureing $x$ directly through $n$ measurements, it would be easier to collect less random and/or compressed measurements and work out what the no-zero values in $x$ are.
        \begin{equation*}
            y = Cx
        \end{equation*}
