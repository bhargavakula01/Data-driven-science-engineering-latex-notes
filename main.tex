...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item In SVD, the column space of $A$ in the equation $A = \tilde{U}\tilde{\Sigma}\tilde{V}^*$ is equal to the column space of $\tilde{U}$ where $\tilde{U}$ is a truncated version of $U$ based on the rank of $X$.
        ...
        \begin{itemize}
            \item In SVD, the row space of $A$ (where $A = \tilde{U}\tilde{\Sigma}\tilde{V}^*$), is equal to the row space of $\tilde{V}^*$ or the column space of $\tilde{V}$. Similarly, $\tilde{V}$ is a truncated version of $V$ based on the rank of $X$.
