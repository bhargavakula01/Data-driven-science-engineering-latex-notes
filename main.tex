...
\begin{itemize}
    ...
    \end{itemize}
    \item Generic properties of Unitary transformation which make them useful:
    \begin{itemize}
        ...
        \item Is invertible and stable numerically (no amplification of error).
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \begin{equation*}
                C = \frac{1}{n}B^*B = \tilde{B}^*\tilde{B} = V(\sum)^2V^*
            \end{equation*}
            ...
            \begin{equation*}
                C = \frac{1}{n-1}B^*B = \tilde{B}^*\tilde{B} = V(\sum)^2V^*
            \end{equation*}
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \begin{equation*}
            f(t) = \sum^\infty_{j,k =-\infty} \left<f(t), \psi_{j,k}\right>\psi_{j,k}(t)
        \end{equation*}
